...
**Mention Poller**:
- Queries [[Pubky Nexus|Pubky Nexus]] API for mentions
...
- Publishes replies to Pubky via [[Explore/Pubky Core/SDK|Pubky SDK]]
...
- **Nexus API**: Depends on [[Pubky Nexus|Pubky Nexus]] for mention polling
