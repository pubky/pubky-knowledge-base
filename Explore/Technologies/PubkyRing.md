...
- **Secure synchronization**: Encrypted sync using [[Homeserver|homeserver]] storage
...
- **X25519 Noise keys**: Automatically derived for [[PubkyNoise|encrypted communication]]
...
Pubky Ring derives [[PubkyNoise|X25519 encryption keys]] from Ed25519 identity keys using HKDF:
