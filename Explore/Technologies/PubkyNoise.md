...
Pubky Noise adapts the Noise Protocol for use with Pubky's [[KeyPair|Ed25519 identity keys]], providing seamless integration with the Pubky ecosystem.
...
**Integration:**
- Derives encryption keys from Pubky [[KeyPair|Ed25519 identities]]
...
Pubky Noise derives X25519 encryption keys from Ed25519 identity keys (managed by [[PubkyRing|Pubky Ring]]):
...
This allows users to use their existing Pubky identity for encrypted communications without managing separate keys. [[PubkyRing|Pubky Ring]] handles this derivation automatically when apps request Noise keys.
...
- [[PubkyRing|Pubky Ring]] - Manages Noise endpoints and sessions
