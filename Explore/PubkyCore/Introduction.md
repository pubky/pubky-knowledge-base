...
3. **[[4.CustomBackend|Complex Backends]]**
   - Custom aggregation and inference
   - Application-specific logic
   - Enhanced features like [[SemanticSocialGraph|Semantic Social Graph]]
...
- Decentralized identity ([[Explore/Technologies/PubkyRing|Pubky Ring]])
...
- **[[Explore/PubkyCore/SDK|SDK Guide]]**: Complete integration documentation
