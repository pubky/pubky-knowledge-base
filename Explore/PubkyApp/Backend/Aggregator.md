...
[[PubkyNexus|Pubky Nexus]] implements a production-grade aggregator (the `nexus-watcher` component) that monitors multiple homeservers in real-time, filtering events and updating the social graph continuously.
