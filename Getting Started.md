...
**[[Explore/Technologies/Pubky Ring|Pubky Ring]]** is your key manager for the Pubky ecosystem. It securely stores your identity and authorizes apps.
...
Use **[[Explore/Technologies/Pubky Explorer|Pubky Explorer]]** ([explorer.pubky.app](https://explorer.pubky.app)) to browse your data:
...
- **Understand the tech**: Check out [[Explore/Pubky Core/ELI5|ELI5: Pubky Core]]
...
Choose your platform and install the [[Explore/Pubky Core/SDK|Pubky SDK]]:
...
**iOS/Android Native**: See [[Explore/Pubky Core/SDK|SDK Documentation]] for UniFFI bindings via `pubky-core-ffi`.
...
Use **[[Explore/Technologies/Pubky Docker|Pubky Docker]]** to run the complete Pubky ecosystem locally:
...
📖 **Full SDK guide**: [[Explore/Pubky Core/SDK|SDK Documentation]]
...
**CLI Tool:**
- [[Explore/Technologies/Pubky CLI|Pubky CLI]] - Reference implementation for user/admin operations
...
If building a social app, leverage [[Explore/Pubky App/Backend/Pubky Nexus|Pubky Nexus]] for:
...
[[Explore/Technologies/Pubky Noise|Pubky Noise]] (work in progress) provides:
...
- **Read the docs**: [[Explore/Pubky Core/Introduction|Pubky Core Overview]]
...
### Technical
- **[[Explore/Pubky Core/API|API Reference]]**: HTTP API spec
- **[[Explore/Pubky Core/SDK|SDK Guide]]**: Client library docs
...
### Tools
- **[[Explore/Technologies/Pubky Docker|Pubky Docker]]**: Local development stack
- **[[Explore/Technologies/Pubky CLI|Pubky CLI]]**: Command-line interface
- **[[Explore/Technologies/Pubky Explorer|Pubky Explorer]]**: Data browser
...
**Ready to build the decentralized web? Start with the [[Explore/Pubky Core/SDK|SDK]]!**
